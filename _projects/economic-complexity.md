...
img: assets/img/economic-complexity/rca_heatmap.png
importance: 2
category: research
toc:
  sidebar: left
...
![Bangalore Industry Space Network](/assets/img/economic-complexity/bangalore_network.png)
...
![Bangalore RCA vs Density SWOT Scatter](/assets/img/economic-complexity/bangalore_swot.png)
...
![Bangalore Development Opportunities](/assets/img/economic-complexity/bangalore_opportunities.png)
...
![City Complexity Profiles](/assets/img/economic-complexity/city_profiles.png)
...
![Cross-City RCA Heatmap](/assets/img/economic-complexity/rca_heatmap.png)
...
![Five-Panel SWOT Scatter](/assets/img/economic-complexity/five_swot_scatter.png)
...
![Five-Panel Industry Networks](/assets/img/economic-complexity/five_networks.png)
...
![Development Opportunities by City](/assets/img/economic-complexity/opportunity_comparison.png)
...
![Delhi Dual Industry Space](/assets/img/economic-complexity/delhi_dual_network.png)
...
![Delhi Formal vs Informal RCA Comparison](/assets/img/economic-complexity/delhi_rca_comparison.png)

### Dual Classification

Industries fall into four categories based on where RCA exceeds 1:

![Delhi Dual Classification](/assets/img/economic-complexity/delhi_dual_bars.png)
...
![Delhi Formalization Pathways](/assets/img/economic-complexity/delhi_pathways.png)
...
![IPL Player Space Network](/assets/img/economic-complexity/ipl_player_space.png)
...
![IPL Franchise Similarity Network](/assets/img/economic-complexity/ipl_franchise_network.png)
...
![Player Journeys Across IPL Franchises](/assets/img/economic-complexity/ipl_player_journeys.png)
...
![Most Connected IPL Players](/assets/img/economic-complexity/ipl_top_connected.png)
...
![IPL Squad Utilisation Heatmap](/assets/img/economic-complexity/ipl_roster_heatmap.png)
...
![Franchise Loyalty Profile](/assets/img/economic-complexity/ipl_franchise_loyalty.png)
