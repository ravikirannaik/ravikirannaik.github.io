...
.mc-reading .rd-title { display: flex; align-items: baseline; gap: 0.6rem; flex-wrap: wrap; }
.mc-reading .rd-title b { color: var(--mc-blue); font-size: 1.05rem; }
.mc-reading .rd-title .mc-badge { background: #d8cfe8; }  /* fuji */
.mc-reading .rd-sub { font-size: 0.9rem; color: var(--global-text-color-light); margin: 0.35rem 0 0.9rem; }
.mc-reading .rd-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0.9rem 1.7rem; }
@media (max-width: 720px) { .mc-reading .rd-grid { grid-template-columns: 1fr; } }
.mc-reading .rd-group > span.h {
  display: block; color: var(--mc-orange); font-size: 0.8rem; font-weight: 700;
  text-transform: uppercase; letter-spacing: 0.03em; margin-bottom: 0.35rem;
}
.mc-reading .rd-group ul { list-style: none; padding: 0; margin: 0; }
.mc-reading .rd-group li { padding: 0.22rem 0; font-size: 0.92rem; line-height: 1.45; }
.mc-reading .rd-group li .m { color: var(--global-text-color-light); }
...
.mc-blink-slow { font-weight: 700; animation: mc-blink 4.5s steps(1) infinite; }
@media (prefers-reduced-motion: reduce) { .mc-blink, .mc-blink-slow { animation: none; } }
</style>
...
<div class="mc-reading" markdown="0">
  <div class="rd-title">
    <b>A Short History of Macroeconomics</b>
    <span class="mc-badge">Enrichment · not for assessment</span>
  </div>
  <p class="rd-sub">Optional background for the "schools of thought" thread: how the field evolved from Keynes to the modern IS–LM/AS–AD toolkit you meet in class, and why economists still disagree.</p>
  <p style="margin:0 0 0.9rem;"><a class="mc-blink-slow" href="{{ '/teachings/macroeconomics-i/history-of-macroeconomics/' | relative_url }}"><strong>▸ Read first: A Short History of Macroeconomics</strong></a> <span class="m" style="color:var(--global-text-color-light);font-size:0.9rem;">— a one-page illustrated walkthrough</span></p>
  <div class="rd-grid">
    <div class="rd-group">
      <span class="h">Start here — encyclopedia entries</span>
      <ul>
        <li><a href="https://www.econlib.org/library/Enc/KeynesianEconomics.html" target="_blank" rel="noopener">Keynesian Economics</a> <span class="m">— EconLib, Concise Encyclopedia</span></li>
        <li><a href="https://www.econlib.org/library/Enc/Monetarism.html" target="_blank" rel="noopener">Monetarism</a> <span class="m">— EconLib</span></li>
        <li><a href="https://www.econlib.org/library/Enc/NewClassicalMacroeconomics.html" target="_blank" rel="noopener">New Classical Macroeconomics</a> <span class="m">— EconLib</span></li>
        <li><a href="https://www.econlib.org/library/Enc/NewKeynesianEconomics.html" target="_blank" rel="noopener">New Keynesian Economics</a> <span class="m">— EconLib</span></li>
        <li><a href="https://en.wikipedia.org/wiki/History_of_macroeconomic_thought" target="_blank" rel="noopener">History of macroeconomic thought</a> <span class="m">— Wikipedia overview</span></li>
      </ul>
    </div>
    <div class="rd-group">
      <span class="h">Blogs — historians of macro</span>
      <ul>
        <li><a href="https://beatricecherrier.wordpress.com/" target="_blank" rel="noopener">The Undercover Historian</a> <span class="m">— Beatrice Cherrier</span></li>
        <li><a href="https://aurelien-goutsmedt.com/tag/history-of-macroeconomics/" target="_blank" rel="noopener">History of Macroeconomics</a> <span class="m">— Aurélien Goutsmedt</span></li>
        <li><a href="https://www.ineteconomics.org/perspectives/blog" target="_blank" rel="noopener">INET Blog</a> <span class="m">— New Economic Thinking</span></li>
      </ul>
    </div>
    <div class="rd-group">
      <span class="h">Listen — podcasts</span>
      <ul>
        <li><a href="https://hetpodcast.libsyn.com/" target="_blank" rel="noopener">Smith and Marx Walk Into a Bar</a> <span class="m">— history of economics</span></li>
        <li><a href="https://www.mercatus.org/macro-musings" target="_blank" rel="noopener">Macro Musings</a> <span class="m">— David Beckworth</span></li>
      </ul>
    </div>
    <div class="rd-group">
      <span class="h">Go deeper — books &amp; a survey</span>
      <ul>
        <li>Snowdon &amp; Vane, <em>Modern Macroeconomics</em> (2005) <span class="m">— clear, with interviews</span></li>
        <li>De Vroey, <em>A History of Macroeconomics from Keynes to Lucas and Beyond</em> (2016)</li>
        <li>Sergi et al., <a href="https://hal.science/hal-05720158" target="_blank" rel="noopener"><em>A History of Macroeconomics</em></a> (2026) <span class="m">— open access</span></li>
      </ul>
    </div>
  </div>
</div>
