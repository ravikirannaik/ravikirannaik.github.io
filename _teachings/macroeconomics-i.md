...
<p><a class="mc-blink-slow" href="{{ '/teachings/macroeconomics-i/history-of-macroeconomics/' | relative_url }}"><strong>▸ A Short History of Macroeconomics</strong></a> — an optional illustrated background reading (schools of thought, from Keynes to IS–LM/AS–AD), with links to encyclopedia entries, blogs, and podcasts.</p>
