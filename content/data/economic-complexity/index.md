---
title: "Economic Complexity of Indian Cities: Industry Space, Informality, and Formalization Pathways"
date: 2026-02-28
tags: ["economic complexity","industry space","informality","India","Bangalore","Delhi","PLFS","urban economics","formalization"]
author: ["Ravikiran Naik"]
description: "Applying economic complexity methods to Indian cities using PLFS 2024: industry space mapping, SWOT analysis, and a novel dual formal-informal complexity framework for Delhi."
summary: "Novel application of economic complexity methods to Indian cities. Maps industry spaces for Bangalore and builds a dual formal-informal complexity framework for Delhi, identifying formalization pathways using PLFS 2024 data."
cover:
    image: "delhi_rca_comparison.png"
    alt: "Delhi formal vs informal RCA comparison scatter plot"
    relative: true
editPost:
    URL: ""
...
The analysis produces two contributions:
...
2. **Delhi: Dual Formal--Informal Industry Space** --- A novel extension that builds *two parallel industry spaces* for formal and informal workers, revealing the dual structure of Delhi's economy and identifying **formalization pathways** --- informal specializations with the highest formal capability readiness.
...
## Part 2: Delhi --- Dual Formal--Informal Complexity
...
+ **Geographic Units:** 744 districts (State $\times$ District from PLFS), Bangalore = Karnataka District 18, Delhi = all districts aggregated
